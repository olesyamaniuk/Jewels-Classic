document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-p-navigation-list");
  const headerRef = document.querySelector(".q-p-header");
  const navigationRef = document.querySelector(".q-p-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".q-p-toggle-button img");
